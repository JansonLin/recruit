...
<body  class="easyui-layout">
	    ...
	    <div data-options="region:'center',title:'主页'" split="true">
			<table id="main_grid" class="easyui-datagrid" style="width:100%;height:97%">
			</table>
		</div>
...
<script type="text/javascript" charset="utf-8" src="<%=basePath%>resources/js/system/user/user_role_edit.js"></script>
</html>
