...
<body class="easyui-layout ">
	<div data-options="region:'center',border:false,split:true" style="width:100%;padding:0 15px;">
			...
			<form id="edit-form" method="post" action="">
				<ul class="itemList clearfix">
	                 <li class=" clearfix item50">
	                    ...
	                    <div class="itemCon">
	                        <input name="id" id="id" type="hidden" value="${sysUser.id}" >
	                        <input class="easyui-textbox" name="userName"  value="${sysUser.userName}"
	                             data-options="width:150,required:true,missingMessage:'用户名称不能为空'" type="text">
	                    </div>
	                  </li>
	                  <li class="clearfix item50">
	                    <span class="itemName"><b>*</b>密码</span>
	                    <div class="itemCon">
	                        <input class="easyui-textbox" name="password"  value="${sysUser.password}" 
	                           data-options="width:150,required:true,missingMessage:'密码不能为空'" type="text">
	                    </div>
	                    </li> 
	                   <li class=" clearfix item50">
	                    <span class="itemName"><b>*</b>手机</span>
	                    <div class="itemCon">
	                        <input class="easyui-textbox" name="phone" value="${sysUser.phone}" 
	                            data-options="width:150,required:true,missingMessage:'手机不能为空'" type="text">
	                    </div>
	                  </li>
	                  <li class="clearfix item50">
	                    <span class="itemName"><b>*</b>姓名</span>
	                    <div class="itemCon">
	                        <input class="easyui-textbox" name="realName" value="${sysUser.realName}"  data-options="width:150" type="text">
	                    </div>
	                    </li> 
	                    <li class=" clearfix item50">
	                    <span class="itemName"><b>*</b>email</span>
	                    <div class="itemCon">
	                        <input class="easyui-textbox" name="email" value="${sysUser.email}"
	                           data-options="width:150,required:true,missingMessage:'email不能为空'" type="text">
	                    </div>
	                  </li>
	                  <li class="clearfix item50">
	                    <span class="itemName">出生日期</span>
	                    <div class="itemCon">
	                        <input class="easyui-datebox" name="birthday" value="${sysUser.birthday}" data-options="width:150">
	                    </div>
	                    </li>      
	                   <li class="clearfix item50" >
	                  ...
	                  <%-- <li class="clearfix">
	                    ...
	                    <div class="itemCon">
	                       <input class="easyui-textbox" name="remark" value="${sysUser.remark}" 
		...
		<div class="fixedBtnBanner">
         ...
         <div id="editDialog" class="easyui-dialog" closed="true" buttons="#dlg-buttons"  style="width:80%;height:100%;">
...
<script type="text/javascript" charset="utf-8" src="<%=basePath%>resources/js/system/user/user_edit.js"></script>
</html>
